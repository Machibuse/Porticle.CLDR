...
public class Units
{
    ...
    public Dictionary<string, Dictionary<string, string>> Long { get; set; } = null!;
    ...
    public Dictionary<string, Dictionary<string, string>> Short { get; set; } = null!;
    ...
    public Dictionary<string, Dictionary<string, string>> Narrow { get; set; } = null!;
    ...
    public Duration DurationUnitTypeHm { get; set; } = null!;
    ...
    public Duration DurationUnitTypeHms { get; set; } = null!;
    ...
    public Duration DurationUnitTypeMs { get; set; } = null!;
}