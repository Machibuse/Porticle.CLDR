...
internal readonly struct PluralFormPatternInfo(string language, PluralFormLength pluralFormLength, GrammaticalCase grammaticalCase, PluralCategory pluralCategory, string text)
{
