...
namespace Porticle.CLDR.Units.UnitInfoClasses
{
    internal abstract class PluralPatternsForUnitLanguageLengthAndCaseBase
    {
        ...
        /// </remarks>
        protected PluralPatternsForUnitLanguageLengthAndCaseBase()
        {
        }
        ...
        /// </summary>
        [SuppressMessage("ReSharper", "UnusedAutoPropertyAccessor.Global", Justification = "Planned for future use")]
